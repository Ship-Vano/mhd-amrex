...
- Глобальная консервативность AMR: реализована (`YAFluxRegister`, гейт `amr.conservation`); открытым остаётся расхождение теплового и магнитного вкладов при перестроении сетки (решение D-007).
